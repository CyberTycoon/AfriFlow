    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className=" transition-all duration-300">
        ...
        <main className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="mb-8">
            <div className="bg-gray-800/80 rounded-xl p-6 border border-amber-500/20 relative overflow-hidden">
            ...
            <div className="bg-gray-800/80 rounded-xl border border-amber-500/20 overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-6">
                  ...
                  {/* Button skeleton */}
                  <div className="h-12 bg-gray-700 rounded-lg animate-pulse mt-4"></div>
                </div>
              </div>
            </div>
