...
const LanguageSelector = ({ formData, setFormData }: Props) => {
  ...
  return (
    <div className="flex justify-between items-center">
      <div className="w-[50%]">
        <label className="w-full block mb-2 text-amber-100">
          🌐 Preferred Language:
        </label>
      </div>
      <div className="w-[50%]">
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="flex items-center">
                ...
                {step < 3 && (
                  <div
                    className={`w-12 h-1 ${
                      step < currentStep ? "bg-amber-500" : "bg-gray-700"
                    }`}
                  />
                )}
              </div>
        ...
        <div
          className={`bg-gray-800/80 rounded-2xl p-6 shadow-xl border border-amber-500/20 transition-all duration-500 ${animationClass} relative overflow-hidden`}
        >
          {/* Decorative elements */}
            ...
            <div className="space-y-6 relative z-10">
              <div className="text-center mb-6">
                ...
                <p className="text-amber-100/60">
                  Start trading, sending money, and getting export help.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="agreeTerms"
                    className="ml-2 text-sm text-amber-100/60"
                  >
                    I agree to the{" "}
                    <Link
                      href="#"
                  ...
                  <label className="flex items-center justify-between cursor-pointer">
                    <div>
                      ...
                      <span className="text-sm text-amber-100/60">
                        Set a voice passphrase for transactions
                      </span>
                    </div>
                ...
                <div className="bg-gray-700/50 rounded-lg p-4 border border-amber-500/20">
                  <label className="flex items-center justify-between cursor-pointer">
                    <div>
                      ...
                      <span className="text-sm text-amber-100/60">
                        Use Face/Touch ID for faster login
                      </span>
                    </div>
                    <div className="relative">
                      <input
